...
public class TennisGameTest {
    ...
    public void checkAllScores() {
        ...
        int m_score_player1 = BEGIN_SCORE;
        int m_score_player2 = BEGIN_SCORE;
        ...
        assertEquals(this.expectedScore, TennisGame.getScore("John", "Bill", m_score_player1, m_score_player2));
    }
    ...
    public static void main(String[] args) {
        //TennisGameTest tennisGameTest  = new TennisGameTest();
    }
}
